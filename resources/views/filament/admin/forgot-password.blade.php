...
<head>
    ...
    <style>
        ...
        input[type=email] {width:100%;padding:12px 14px;border:1px solid #d1d5db;border-radius:10px;font-size:0.95rem;}
...
<body>
    <main class="card">
        <h1>Lupa Password</h1>
        <p>Masukkan email admin. Kami kirim tautan reset via Supabase.</p>
        ...
        <form method="POST" action="{{ route('password.forgot') }}">
            ...
            <input type="email" name="email" id="email" value="{{ old('email', 'tiaranafarma@gmail.com') }}" required autocomplete="email" autofocus>
